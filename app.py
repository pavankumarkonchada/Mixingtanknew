...
def launch_fluent():
    ...
    command_to_execute = f'"{python_executable}" -c "from ansys.fluent.core import launch_fluent;import ansys.fluent.core as pyfluent;pyfluent.launch_fluent(precision=\'double\', processor_count=4, mode=\'meshing\', show_gui=False);meshing.workflow.InitializeWorkflow(WorkflowType="Watertight Geometry");path=r"C:\check\geom1.scdoc";meshing.workflow.TaskObject["Import Geometry"].Arguments = {"FileName": path,"LengthUnit": "mm",}"'
